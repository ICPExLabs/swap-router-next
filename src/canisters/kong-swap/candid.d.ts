...
export interface AddTokenReply {
    IC: ICTokenReply;
}
...
export type CheckPoolsResult = { Ok: CheckPoolsReply[] } | { Err: string };
...
export type ClaimsResult = { Ok: ClaimsReply[] } | { Err: string };
...
export type MessagesResult = { Ok: MessagesReply[] } | { Err: string };
...
export type PoolsResult = { Ok: PoolReply[] } | { Err: string };
...
export type RequestsResult = { Ok: RequestsReply[] } | { Err: string };
...
export type TokensResult = { Ok: TokenReply[] } | { Err: string };
...
export type TransfersResult = { Ok: TransferIdReply[] } | { Err: string };
...
export type TxsReply =
    ...
    | { AddPool: AddPoolReply }
    | { RemoveLiquidity: RemoveLiquidityReply };
export type TxsResult = { Ok: TxsReply[] } | { Err: string };
export interface UpdateTokenArgs {
    token: string;
}
export interface UpdateTokenReply {
    IC: ICTokenReply;
}
export type UpdateTokenResult = { Ok: UpdateTokenReply } | { Err: string };
export interface UserBalancesReply {
    LP: LPBalancesReply;
}
export type UserBalancesResult = { Ok: UserBalancesReply[] } | { Err: string };
...
export interface _SERVICE {
    ...
    icrc10_supported_standards: ActorMethod<[], Icrc10SupportedStandards[]>;
